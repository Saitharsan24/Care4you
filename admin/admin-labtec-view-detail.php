               ...
               <table class="view-doc">
                    <tr>
                        <td rowspan = 3 style="width:100px;">
                            <img src="../images/user-profilepic/labtec/<?php echo $row['profile_picture']; ?>" alt="user" class="ppframe" style="width: 175px; height: 175px;">
                        </td>
                        <td class="typeR">Full Name :</td>
                        <td class="typeL"><?php echo $row['fullname']; ?></tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <?php
                            ...
                            <?php 
                                ...
                                document.getElementById('del').action = '?id=<?php echo $row['labtec_id']?>&activate=<?php echo $row['userid']?> ';
                                " >
