    ...
    <div class="wrapper">
        <div class="sidebar">
            ...
            <ul>
                ...
                <li><a href="admin-order-view.php"><div class="highlighttext">Orders</a></li>
                <li><a href="admin-doc-appointment.php">Appointments</a></div></li>
        ...
        <div class="main_content">
            ...
            <div class="doc-apt-title-detail" id="id"> Order Details</div>
