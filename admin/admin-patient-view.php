...
<div class="table-1">
          <table>
            ...
            echo '<tr class="body-1">
              <td class="td-1">'.$row['lab_asst_ID'].'</td>
              <td>'.$row['name'].'</td>
              <td>'.$row['user_name'].'</td>
        ...
        <button class="button-1" onclick="location.href='admin-patient-reg.php'">Register laboratory</button>
