  ...
  <span class="overlay"></span>
    ...
    <div class="modal-box">
        ...
        <form action="" method="POST">
            ...
            <input type="text" step="500" name="address" class="inputtab" value="<?php echo $row['address'] ?>" placeholder="Enter New address" />

            <div class="buttons">
            <button class="modbutton close-btn">Close</button>
            <button class="modbutton" type="submit" name="update_address"  style="background-color: #008000; color: #fff;">Update</button>
            </div>
