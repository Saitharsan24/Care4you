                ...
                <div class="square">
                    ...
                    <table class="tbl-square">
                        ...
                        <tr>
                            ...
                            <td class="type2"><?php echo '0'.$Admin_contact_number; ?></td>
                        </tr>
                    </table> 
                </div>
                    <a href="admin_Editprofile.php"><button class="btn-editP square2"><i class="fa-solid fa-pen-to-square"></i> &nbsp; Edit Profile</button></a>                      
