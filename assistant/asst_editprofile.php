    ...
    <div class="wrapper">
        <div class="sidebar">
            ...
            <ul>
                ...
                <li><a href="asst_viewprofile.php"><div class="highlighttext">Profile</div></a></li>
            </ul>
            <div class="signouttext"><a href="../logout.php"><i class="fa-solid fa-right-from-bracket"></i> Sign Out </a></div>
        </div>
        <div class="main_content"> 
            <div class="info">
            <div class="back" onclick="location.href='asst_viewprofile.php'">
                ...
                <div class="square" style="height:470px;">
                    ...
                    if (isset($_POST['ppUpdate'])) 
                    {
                        ...
                        if (isset($_FILES['file'])) 
                        {
                            ...
                            $new_ppname = 'User_' . $assistant_id . '_Updated' . '.' . $extension;

                            // Move the file to a permanent location
                            $destination= "../images/user-profilepic/assistant/".$new_ppname;
                            ...
                            if($upload == FALSE)
                            {
                                ...
                                header('location:'.SITEURL.'/assistant/asst_editprofile.php'); 
                                //Stop the process
                                die();
                            }
                            else
                            {
                                ...
                                $sqlpp = "UPDATE tbl_assistant SET profile_picture='$new_ppname' WHERE assistant_id ='$assistant_id'";
                    ...
                    <a href="asst_editprofile.php"><button class="btn-saveP square4" type="submit" name="update">
                    <i class="fa-solid fa-rotate-right"></i>
                    &nbsp; Update Profile</button></a>
                    </form>                      
                    <img src="../images/user-profilepic/assistant/<?php echo $profile_picture; ?>" alt="user" class="circle" style="margin-top:-10px;"/>
                    <div id="overlap"></div>
            </div>
            </div>
        </div>
...
<?php
    ...
    if(isset($_POST['update'])) {
        ...
        $selsql = "SELECT name, nic, phoneno FROM tbl_assistant WHERE assistant_id ='$assistant_id'";
        ...
        if ($row['name'] == $fullname && $row2['email'] == $email && $row['nic'] == $nic && $row['phoneno'] == $contact_number) {
            // Data is not updated
            $_SESSION['update-user'] = '<div class="ppUpEr" style="padding-top:25px;"> No Changes made to Profile Details</div>';
            echo "<script> window.location.href='http://localhost/Care4you/assistant/asst_editprofile.php';</script>";
        }
        else {
            // Data is updated
            //Step 04 - SQL Query to save the data in Database
            $sql3 = "UPDATE tbl_assistant SET 
                name = '$fullname',
                nic = '$nic',                
            ...
            if($res3 == TRUE) {
                ...
                echo "<script> window.location.href='http://localhost/Care4you/assistant/asst_viewprofile.php';</script>";
            }
            else {
                //Data not inserted
