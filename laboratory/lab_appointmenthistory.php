        ...
        <div class="main_content">
            ...
            <div class="order-filter-btn">
                <div class="right-button order-filter-main-btn">
                    <a href="?pendingid "><button style="width: 180px;" class="btn-press" name="pendingpayment">Payment
                            Pending</button></a>
                ...
                if (isset($_GET['pendingid']) || isset($_GET['confirmedid']) || isset($_GET['completeid'])) { ?>
                    <div class="clearfilt-order"><a href="./lab_appointmenthistory.php"><i class="fa-solid fa-circle-xmark"
                                style="color: #0d5c75;"></i>Clear filter</a></div>
                <?php } ?>
                        ...
                        <tbody>
                            ...
                            if ($result) {
                                while ($rowRespond = mysqli_fetch_assoc($result)) {
                                    ...
                                    <tr>
                                        <td>
                                            <?php echo $rowRespond['labapt_id'] ?>
                                        </td>
                                        <td>
                                            <?php echo $rowRespond['first_name'] ?>
                                        </td>
                                        <td>
                                            <?php echo $rowRespond['labapt_date'] ?>
                                        </td>
                                        <td>
                                            <?php
                                        ...
                                        <td>
                                            <a href="./lab_viewrespondedapt.php?id=<?php echo $rowRespond['labapt_id'] ?>"><button
                                                    class="btn-view"><span>View Details</span></button></a>
                                        </td>
                                    </tr>
