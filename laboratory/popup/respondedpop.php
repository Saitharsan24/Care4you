...
<section id="respondsuccess">
  <span class="overlay" onclick="closePopupRS()"></span>
  ...
  <div class="modal-box" style="width:28%; height:45%; text-align: center; justify-content: center;align-items: center;">
    ...
    <div class="buttons" style="display:flex; margin-left:0px; margin-top:20px;">
      <button class="button  close-btn " style="width:100px;" onclick="closePopupRS()">Ok</button>
    </div>
  </div>
</section>
...
<script>
    function openPopupRS() {
    const sectionC = document.getElementById("respondsuccess");
    sectionC.classList.add("active");
  }

  function closePopupRS() {  
    console.log('Check');
  const sectionC = document.getElementById("respondsuccess");
