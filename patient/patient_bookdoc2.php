          ...
          <div class="apt-btn form-set-btn">
            ...
            <div class="apt-btn-css">
              ...
              <script src="https://checkout.stripe.com/checkout.js" class="stripe-button"
                data-key="<?php echo $_SESSION['public_key'] ?>" data-amount="<?php echo ($booking_fee + $doc_fee) * 100 ?>"
                data-name="CareForYou Payment" data-description="Make doctor appointment payment" data-currency="lkr"
                data-image="../images/logoicon.png" data-email="<?php echo $pemail ?>">
                </script>
