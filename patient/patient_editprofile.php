            ...
            <div class="polygons">
                <div class="square">
                    ...
                    <form id="upload-form" method="POST" enctype="multipart/form-data">
                        <figcaption class="txtpp" style="text-align:center;"><a href="#" id="file-link">Change Profile
                                Picture</a><br />
                        </figcaption>
                                ...
                                <tr>
                                    ...
                                    <td class="type2"
                                        ...
                                        <input type="tel" class="form-control" name="contact"
                                            value="<?php echo '0' . $contact; ?>" required="" />
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="type1" style="padding-right: 15px;">
                                        <button class="btn-pwd" style="font-size: 13px;" type="button">
                                            <a href="patient_changepassword.php">
                                                <span><i class="fa-solid fa-lock" style="font-size: 15px;"></i> &nbsp;
