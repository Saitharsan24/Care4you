            ...
            <tbody>
              ...
              if (isset($_SESSION['output'])) {
                if ($_SESSION['output'] == 0) {
                  ?>
                  <tr>
                    <td colspan="5" class="nosessiontd">
                      <div class="nosession">No Sessions Available</div>
                    </td>
                  </tr>
                  <?php
                  // echo 'nothing';
                  ...
                  foreach ($_SESSION['output'] as $row3) {
                    if ($row3['no_of_appointment'] < 13 && $row3['status'] == 1) {
                      ...
                      <tr>
                        <td>
                          <?php echo $row3['doc_name'] ?>
                        </td>
                        <td>
                          <?php echo $row3['specialization'] ?>
                        </td>
                        <td>
                          <?php echo $row3['date'] ?>
                        </td>
                ...
                while ($row3 = mysqli_fetch_array($result3)) {
                  if ($row3['no_of_appointment'] < 13 && $row3['status'] == 1) {
                    ...
                    <tr>
                      ...
                      <td><a href="./patient_bookdoc1.php?id=<?Php echo $row3['session_id'] ?>"><button
                            class="book-btn"><span>Book Now</span></button></a></td>
                    </tr>
                    <?php
                  }
                }
