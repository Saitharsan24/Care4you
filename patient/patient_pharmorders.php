  ...
  <div class="main-div">
    ...
    <div class="home-right">
      ...
      <div class="text-content"
        ...
        <div class="mk-odr-btn"><a href="./patient_makeorder.php"><button class="btn-mkdcapt"><span>make pharmacy
                order</span></button></a></div>
      </div>
              ...
              while ($row = mysqli_fetch_array($result)) {
                ...
                <tr>
                  ...
                  if ($row['order_status'] == 0) { ?>
                    <td><button class="order-st00">
                        <?php echo 'Response Pending'; ?>
                      </button></td>
                    <?php
                  } else if ($row['order_status'] == 1) { ?>
                      <td><button class="order-st01">
                        <?php echo 'Payment Pending'; ?>
                        </button></td>
                    <?php
                  } else if ($row['order_status'] == 2) { ?>
                        <td><button class="order-st02">
                        <?php echo 'Order Confirmed'; ?>
                          </button></td>
                    <?php
                  } else if ($row['order_status'] == 3) { ?>
                          <td><button class="order-st03">
                        <?php echo 'Order Dispatched'; ?>
                            </button></td>
                    <?php
                  } else if ($row['order_status'] == 4) { ?>
                            <td><button class="order-st04">
                        <?php echo 'Delivered'; ?>
                              </button></td>
                    <?php
                  } else if ($row['order_status'] == 5) { ?>
                              <td><button class="order-st05">
                        <?php echo 'Cancelled'; ?>
                                </button></td>
                    <?php
                  } ?>
                  ...
                  <td><a
                      href="patient_pharmorderViewDetails.php?id=<?php echo $row['order_id']; ?>&status=<?php echo $row['order_status']; ?>"><button
                        class="book-btn"><span>View Details</span></button></a></td>
                  <?php
              }
            } else {
              ?>
