    ...
    <div class="main-div">
      ...
      <div class="home-right">
        ...
        <div class="view-lab-apt-details">
          <div class="view-details-row-lab">Reference No :<div></div></div>
          <div class="view-details-row-lab">Date :<div></div></div>
          <div class="view-details-row-lab">Time :<div></div></div>
          <div class="view-details-row-lab">Patient name :<div></div></div>
          <div class="view-details-row-lab">NIC No :<div></div></div>
          <div class="view-details-row-lab">Status :<div></div></div>
          <div class="view-details-row-lab">Total Amount :<div></div></div>
