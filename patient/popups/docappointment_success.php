...
<section id="reschedule">
  <span class="overlay" onclick="closePopupR()"></span>

  <div class="modal-box" style="width:28%; height:45%; text-align: center; justify-content: center;align-items: center;">
    <i class="fa-solid fa-circle-check" style="color: #28ae28;margin-top:-20px;"></i> <br/>
    <h3 style="font-size:20px; font-weight:700;">Successfully<br/> rescheduled your appointment</h3>

    <div class="buttons" style="display:flex; margin-left:0px; margin-top:20px;">
      <button class="button  close-btn " style="width:100px;" onclick="closePopupR()">Ok</button>
    </div>
  </div>
</section>

<section id="cancelledsuccess">
  <span class="overlay" onclick="closePopupCS()"></span>

  <div class="modal-box" style="width:28%; height:45%; text-align: center; justify-content: center;align-items: center;">
    <i class="fa-solid fa-circle-check" style="color: #28ae28;margin-top:-20px;"></i> <br/>
    <h3 style="font-size:20px; font-weight:700;">Successfully<br/>cancelled your appointment</h3>

    <div class="buttons" style="display:flex; margin-left:0px; margin-top:20px;">
      <button class="button  close-btn " style="width:100px;" onclick="closePopupCS()">Ok</button>
    </div>
  </div>
</section>
...
<script>
  ...
  function openPopupR() {
    const sectionC = document.getElementById("reschedule");
    sectionC.classList.add("active");
  }
  ...
  function openPopupCS() {
    const sectionC = document.getElementById("cancelledsuccess");
    sectionC.classList.add("active");
  }

  function closePopupCS() {  
    console.log('Check');
  const sectionC = document.getElementById("cancelledsuccess");
  sectionC.classList.remove("active");
  }
