...
<?php include('pharmacy_getinfo.php') ?>
    <div class="wrapper">
        ...
        <div class="main_content"> 
            <div class="info">
            <div class="back" onclick="location.href='pharmacy_editprofile.php'">
            ...
            <div class="polygons">
                ...
                <br /><br /><br /><br /><br /><br />
                    ...
                    <a href="pharmacy_editprofile.php">
                    ...
                    <img src="../images/user-profilepic/pharmacist/<?php echo $profile_picture; ?>" alt="user"
...
if (isset($_POST['submit'])) {
    ...
    if (empty($newpwd)) {
        ...
        echo "<script> window.location.href='http://localhost/Care4you/pharmacy/pharmacy_changepassword.php';</script>";
        exit();
